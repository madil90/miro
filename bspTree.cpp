...
void BSPTree::buildBSPTree()
{
	...
	// starting tree
	std::cout<<"Initializing tree with max depth "<<max_depth<<std::endl;
	...
	time(&end);
	std::cout<<"Time Taken to build tree "<<difftime(end,begin)<<std::endl;
}
	...
	// other wise
		...
		for (int i=0;i<3;i++){
			...
			for (int j=1;j<=nSplits;j++){
				...
				// print costs
				// std::cout<<"Cost no split "<<cost_no_split<<std::endl;
				...
				// std::cout<<"cut axis is "<<i<<std::endl;
				// std::cout<<"cut pos is "<<splitPos<<std::endl;
				// std::cout<<"difference is "<<diff<<std::endl;
				// std::cout<<"objects above are "<<objsAbove.size()<<std::endl;
				// std::cout<<"objects below are "<<objsBelow.size()<<std::endl;
				// std::cout<<std::endl;
		...
		// std::cout<<"best cut axis is "<<bestCut.axis<<std::endl;
		// std::cout<<"best cut pos is "<<bestCut.pos<<std::endl;
		// std::cout<<"lowest cost is "<<lowestCost<<std::endl;
		// std::cout<<"objects above are "<<noObjsAbove<<std::endl;
		// std::cout<<"objects below are "<<noObjsBelow<<std::endl;
		// std::cout<<"total objects were "<<objects.size()<<std::endl;
		// std::cout<<"total cost is "<<cost_no_split<<std::endl;
		// std::cout<<std::endl;
