...
<global>bsp{WS}splits{WS} {return BSPSPLITS;}
<global>path{WS}trace{WS} {return PATHTRACE;}
<global>photon{WS}mapping{WS} {return PHOTONMAP;}
<global>caustic{WS}photons{WS} {return CAUSTICPHOTONS;}
<global>global{WS}photons{WS} {return INDIRECTPHOTONS;}
<global>photons{WS}estimate{WS} {return PHOTONSESTIMATE;}
<global>caustic{WS}estimate{WS} {return CAUSTICESTIMATE;}
<global>final{WS}gather{WS} {return FINALGATHER;}
...
<areaLight>samples{WS} {return SAMPLES;}
<areaLight>render{WS} {return RENDERLIGHT;}
